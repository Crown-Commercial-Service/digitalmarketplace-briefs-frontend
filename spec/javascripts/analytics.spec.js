describe('GOVUK.Analytics', function () {
  ...
  const SortCallsToGaByMethod = function (calls) {
    var gaMethodCalls = {}
    var callNum = calls.length

    while (callNum--) {
      var method = calls[callNum].args.shift()
      var args = calls[callNum].args

      if (Object.prototype.hasOwnProperty.call(gaMethodCalls, method)) {
  ...
  SortCallsToGaByMethod.prototype.callsTo = function (method) {
    if (Object.prototype.hasOwnProperty.call(this._calls, method)) {
  ...
  xdescribe('when registered', function () {
  ...
  xdescribe('link tracking', function () {
    var mockLink
    var assetHost = 'https://assets.digitalmarketplace.service.gov.uk'
  ...
  xdescribe('Virtual Page Views', function () {
    var $analyticsString
